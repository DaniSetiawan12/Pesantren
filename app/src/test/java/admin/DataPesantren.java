...
public class DataPesantren extends AppCompatActivity
        implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsList.clear();
        adapter = new AdapterPuskes(DataPesantren.this, newsList);
    ...
    public void onBackPressed() {
        Intent i = new Intent(DataPesantren.this, HomeAdmin.class);
        startActivity(i);
        finish();
    }
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent a = new Intent(DataPesantren.this, DetailPesantren.class);
