...
public class DetailPesantren extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabAddGambar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(DetailPesantren.this, TambahGambar.class);
                i.putExtra("_id", _id);
                startActivity(i);
                finish();
            }
                        ...
                        .when(new Pop.Yah() {
                            ...
                            public void clicked(DialogInterface dialog, View view) {
                                ...
                                try {
                                    ...
                                    jsonObj1.put("lon", lg);
                                    updateData(jsonObj1);
                                    Intent i = new Intent(DetailPesantren.this, DataPesantren.class);
                                    startActivity(i);
                                    finish();
                                } catch (JSONException e) {
                                    e.printStackTrace();
        ...
        fabUbahJamBuka.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(DetailPesantren.this, UbahJamBuka.class);
                i.putExtra("_id", _id);
