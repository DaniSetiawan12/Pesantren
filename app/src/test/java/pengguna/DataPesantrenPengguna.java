...
public class DataPesantrenPengguna extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsList.clear();
        adapter = new AdapterPenggunaPuskes(DataPesantrenPengguna.this, newsList);
...
//                                    final String alamat = jsonObject.getString("alamat");
                                    ...
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent a = new Intent(DataPesantrenPengguna.this, DetailPesantrenPengguna.class);
...
//                                    newsList.clear();
    ...
    public void onBackPressed() {
        Intent i = new Intent(DataPesantrenPengguna.this, HomeUser.class);
        startActivity(i);
        finish();
    }
