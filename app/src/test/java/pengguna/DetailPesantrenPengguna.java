...
public class DetailPesantrenPengguna extends AppCompatActivity {
        ...
        goRoutes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mapIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    Toast.makeText(DetailPesantrenPengguna.this, "Google Maps Belum Terinstal. Install Terlebih dahulu.",
